...
const CopyrightPage = () => {
    return (
        <div className="relative flex flex-col items-center justify-center gap-y-4 bg-gradient-to-b from-gray-300 to-gray-500 opacity-90 px-6 py-0 sm:px-3.5 m-0">
