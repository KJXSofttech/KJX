...
import styled from "styled-components"; // Change import to styled-components
import JunkImage from "../../../assets/ecommerce.jpg"; // Ensure image is imported as value
import RailkafeImage from "../../../assets/ecommerce.jpg"; // Ensure image is imported as value

const BotSlider = () => { // Changed function name to PascalCase
  const settings = {
    dots: true,
    infinite: true,
    speed: 500,
    ...
    autoplaySpeed: 2000, // Auto-scroll speed in milliseconds (2 seconds)
...
export default BotSlider; // Changed export to PascalCase
